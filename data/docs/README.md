...
### architecture/
- [技术方案设计 v0.1](architecture/技术方案设计.md) — 总体架构、域模型、关键模块、API 清单、风险与排期
...
- [Auth](api/auth.md) — 微信登录 + 真人认证
- [Profile](api/profile.md) — 用户资料 + 人格卡
- [Voice](api/voice.md) — 实时语音 WebSocket 协议
- [Feed](api/feed.md) — 广场 / 帖子 / 评论
- [Social](api/social.md) — 关注 / 粉丝
- [Memory](api/memory.md) — 记忆库 / 洞察
- [Match](api/match.md) — 每周匹配
- [Payment](api/payment.md) — 微信支付 + 权益
